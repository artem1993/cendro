...
gulp.task("fontsStyle", () => {
    ...
    let fontsFile = `${srcPath}/scss/base/_fontsAutoGenerate.scss`
    // Проверяем существуют ли файлы шрифтов
    fs.readdir(`${docsPath}/fonts/`, function (err, fontsFiles) {
        if (fontsFiles) {
